...
def display_results():
    ...
    # Display Data Button
    display_statistics_button = ctk.CTkButton(filter_frame, text="Search !", command=view_results) # <--- display_statistics_button = ctk.CTkButton(filter_frame, text="Voir Resultat", command=fetch_game_statistics())
...
def insert_data_into_treeview(tree, values, percentage):
    ...
    # Add the percentage value to the tuple of values
